		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
				<div class="card border-0 bg-light rounded shadow">
					<div class="card-body p-4">
						...
						%>
						<span
							class="badge rounded-pill bg-primary float-md-end mb-3 mb-sm-0"><%=count%>
							CONTACT </span>
						<h5>Contact List</h5>
						<div class="mt-3">
			...
			<div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
				<div class="card border-0 bg-light rounded shadow">
					<div class="card-body p-4">
						...
						%>
						<span
							class="badge rounded-pill bg-primary float-md-end mb-3 mb-sm-0"><%=project_count%>
							Projects </span>
						<h5>Add Projects</h5>
						<div class="mt-3">
							<span class="text-muted d-block"><i class="fa fa-home"
			...
			<div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
				<div class="card border-0 bg-light rounded shadow">
					<div class="card-body p-4">
						...
						<div class="mt-3">
							<a href="update-project.jsp" class="btn btn-primary">Update
								Project</a>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
				<div class="card border-0 bg-light rounded shadow">
					<div class="card-body p-4">
						...
						%>
						<span
							class="badge rounded-pill bg-primary float-md-end mb-3 mb-sm-0"><%=edu_count%>
							Education </span>
						<h5>Education</h5>
						<div class="mt-3">
							<span class="text-muted d-block"><i class="fa fa-home"
						...
						<div class="mt-3">
							<a href="education.jsp" class="btn btn-primary">Edit
								Education</a>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
				<div class="card border-0 bg-light rounded shadow">
					<div class="card-body p-4">
						<%
						int cer_count = new CertificatesDao().countCer();
						%>
						<span
							class="badge rounded-pill bg-primary float-md-end mb-3 mb-sm-0">
							<%=cer_count %> Certificates </span>
						<h5>Certificates</h5>
						<div class="mt-3">
							<span class="text-muted d-block"><i class="fa fa-home"
								aria-hidden="true"></i> <a href="#" target="_blank"
						...
						<div class="mt-3">
							<a href="certificates.jsp" class="btn btn-primary">Edit
								Certificates</a>
						</div>
					</div>
				</div>
